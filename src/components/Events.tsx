...
const events: EventData[] = [
    {
      ...
      },
      {
        ...
        "image_url": "https://bit.ly/placeholder-img",
        "target": "https://t.me/joinchat/eNHADkJLCaMzZTM8"
      },
      {
        "id": 3,
  ...
  return (
    <section className="relative flex flex-col items-center justify-center w-full py-16 bg-white md:py-20 gap-y-2 md:gap-y-5">
      ...
      <div className="grid grid-cols-1 gap-y-4 md:gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 xl:gap-x-8 md:grid-cols-2 bg-[#09AFC6] px-4 md:px-10 lg:px-16 py-8 md:py-14 xl:py-16">
        ...
        <div className="flex items-center justify-center pt-1 tracking-wide text-white md:pt-0 md:text-right md:absolute md:bottom-24 md:right-10 2xl:bottom-36 lg:right-16 see-more-div hover:tracking-widest hover:transition-all hover:duration-500 hover:underline">
        <Link href="https://kommunity.com/reactjs-developer-community-kenya-reactdevske/events" className='see-more-link'>
          <a target="_blank" className='see-more'>See More</a>
        </Link>
      </div>
      </div>
