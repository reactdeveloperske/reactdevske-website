...
export const getStaticProps = async () => {
  const data = [
    ...
    {
      name: 'Reactjs Developer Community in Kenya',
      src: logo,
      event: false,
      description:
        'React js Developer Community Kenya is a community of react js developers using react related technologies in the Kenyan software development eco system.',
      venue: 'iHub',
      date: '2022-06-15',
    },
    {
